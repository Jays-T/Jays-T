...
- 🔭 I’m currently mentoring two teams for the Code Institute Hackathon [Code Institute St Patricks Day Hackathon](https://hackathon.codeinstitute.net/) working on [My Portfolio](https://jays-t.github.io/resume) which will be my personal site and I took part in Hacktober Fest contributing four successful PR's to [Code Institute Hackathon App](https://github.com/Code-Institute-Community/ci-hackathon-app) for experience, and the fun of collaborating with fellow coders.
